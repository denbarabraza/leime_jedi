import { IListItem } from '@/components/features-list/interface';
...
import megaMenu from '../assets/mega-menu.png';
import newsletterSubscription from '../assets/news-letter-subscription.png';
import onlineChat from '../assets/online-chat.png';
import parallax from '../assets/parallax.png';
import portfolio from '../assets/portfolio.png';
import pricingTables from '../assets/pricing-tables.png';
import slider from '../assets/slider.png';
import socialLogin from '../assets/social-login.png';
import themeColorSwitcher from '../assets/theme-color-switcher.png';
import uiElements from '../assets/ui-elements.png';
import validSemanticCoding from '../assets/valid-semantic-coding.png';
...
export const listItems: IListItem[] = [
  ...
  },
  {
    ...
    title: 'GOOGLE FONTS',
    description:
      'Your site wont be boring style on the web. Having a decent library of fonts that are easy to implement Google creates a look for every site.',
    image: googleFonts,
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description: 'Easily subscribe your visitors to your newsletter.',
    image: newsletterSubscription,
  },
  {
    id: 11,
    title: 'SOCIAL LOGIN',
